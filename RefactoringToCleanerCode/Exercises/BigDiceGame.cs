public static class BigDiceGame
{
    public static int GetScore(ScoringType st, int die1, int die2, int die3, int die4, int die5)
    {
        switch (st)
        {
            ...
            {
                return AppleSauce2(die1, die2, die3, die4, die5);
            }

            case ScoringType.FullHouse:
            {
                return AppleSauce3(die1, die2, die3, die4, die5);
            }
    ...
    private static int AppleSauce3(int die1, int die2, int die3, int die4, int die5)
    {
        int[] tallies;
        var _2 = false;
        int i;
    ...
    private static int AppleSauce2(int die1, int die2, int die3, int die4, int die5)
    {
