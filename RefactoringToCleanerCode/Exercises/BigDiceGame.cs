public static class BigDiceGame
{
    public static int CalculateScore(ScoringType st, int die1, int die2, int die3, int die4, int die5)
    {
        ...
        switch (st)
        {
            ...
            {
                return Stuff(die1, die2, die3, die4, die5);
            }

            case ScoringType.TwoPair:
            {
                return Stuff2(die1, die2, die3, die4, die5);
            }
    ...
    private static int Stuff2(int die1, int die2, int die3, int die4, int die5)
    {
    ...
    private static int Stuff(int die1, int die2, int die3, int die4, int die5)
    {
        const int value = 2;
        int[] tallies1;
        tallies1 = new int[6];
