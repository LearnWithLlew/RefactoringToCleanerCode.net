public static class BigDiceGame
{
    public static int CalculateScore(ScoringType st, int die1, int die2, int die3, int die4, int die5)
    {
        switch (st)
        {
            ...
            {
                return SecondParagraph(die1, die2, die3, die4, die5);
            }

            case ScoringType.FullHouse:
            {
                return ThirdParagraph(die1, die2, die3, die4, die5);
            }
    ...
    private static int ThirdParagraph(int die1, int die2, int die3, int die4, int die5)
    {
        int[] tallies;
        var _2 = false;
        int i;
    ...
    private static int SecondParagraph(int die1, int die2, int die3, int die4, int die5)
    {
