...
{
    public static int CalculateScore(ScoringType scoringType, int dieOne, int dieTwo, int dieThree, int dice4, int fifthDie)
    {
        ...
        switch (scoringType)
        {
            ...
            {
                int[] dice1 = {dieOne, dieTwo, dieThree, dice4, fifthDie};
